<h2><a href="https://www.geeksforgeeks.org/problems/replace-all-0s-with-5/1?page=1&category=Arrays,Strings&company=Amazon,Microsoft,Flipkart,Adobe,Google,Samsung,MakeMyTrip,Zoho,Paytm,Walmart,Goldman%20Sachs,Morgan%20Stanley,D-E-Shaw,Oracle,Facebook,VMWare,Qualcomm,Intuit,Cisco,Linkedin,Yahoo,TCS,Twitter,Atlassian,Uber&sortBy=accuracy">Replace all 0's with 5</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given an integer N. You need to convert all zeroes of N&nbsp;to 5. </span></p>
